...
from . import views
from JobOffers.views import JobOfferGP, JobOfferGPD, apply, get_unread_notifications, getApplicationCandidates, getApplications, getJobOffersByRecruiter,getMatches, mark_notification_as_read, matchCandidateWithJobs
